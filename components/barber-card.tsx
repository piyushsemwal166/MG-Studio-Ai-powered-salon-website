...
export function BarberCard({ name, title, specialty, bio, image, isOwner }: BarberCardProps) {
  if (isOwner) {
    return (
      <div className="bg-card border border-primary/30 rounded-lg overflow-hidden reveal-up transition-smooth hover-lift">
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="p-8 flex flex-col justify-center">
            ...
            <h2 className="text-3xl font-serif font-bold text-foreground mb-4">{name}</h2>
